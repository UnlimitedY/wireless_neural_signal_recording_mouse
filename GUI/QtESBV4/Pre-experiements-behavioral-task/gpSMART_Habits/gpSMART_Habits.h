...
const PROGMEM String OutputActionNames[] = { // 29 in total = 8 nDOs + 8 nPWMs + 4 ntPWMs + 2 Serial + 3 Global + 4 Flag
...
extern byte smartFlag[4]; // flags1-4 for loop
